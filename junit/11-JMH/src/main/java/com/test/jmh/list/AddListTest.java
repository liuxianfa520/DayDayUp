...
public class AddListTest {
    ...
    @Benchmark
    public void testLinkedListAdd(Blackhole blackhole) {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(AddListTest.class.getSimpleName())
                .result(FileUtil.file(AddListTest.class.getSimpleName() + System.currentTimeMillis() + "_result.json").getAbsolutePath())
