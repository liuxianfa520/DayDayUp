...
public class FileUploadUtil {
    // 文件上传的目录
    public static final String UPLOAD_FILE_DIR = SpringUtil.getProperty("upload.filePath"); //Constants.UPLOAD_DIR + "file/";
    // 缩略图存放的目录
    public static final String UPLOAD_SM_DIR = Constants.UPLOAD_DIR + "thumbnail/";
    
    public static final String UPLOAD_PATH = SpringUtil.getProperty("upload.urlDomain");
