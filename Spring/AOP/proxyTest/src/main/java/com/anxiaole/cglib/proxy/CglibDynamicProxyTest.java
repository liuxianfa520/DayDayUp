package com.anxiaole.cglib.proxy;
...
public class CglibDynamicProxyTest implements MethodInterceptor {
    public static void main(String[] args) {
        ...
        CglibDynamicProxyTest cglibDynamicProxyTest = new CglibDynamicProxyTest(new LoginService());

        Object proxy = cglibDynamicProxyTest.getProxy();
        ((LoginService) proxy).login("lxf", "asdf");
    }

    private Object targetObject;

    public CglibDynamicProxyTest(Object targetObject) {
